...
static const struct RankSpawnData RANK_DATA[MAX_RANK] = {
    ...
    {550 , {3,2}, {0 ,15 ,95 ,100}, {10 ,65 ,100}, 17, 1.5f, {{7 ,15}, {5,8 },{0,0}}},
    {800 , {3,1}, {0 ,10  ,90 ,100}, {0  ,85 ,100}, 20, 1.7f, {{9,18}, {6,8 },{1,10}}},
    {1000, {2,2}, {0 ,10 ,85 ,100}, {10 ,70 ,100}, 22, 2.0f, {{10,20}, {7,10},{1,10}}},
    {1400, {2,2}, {0 ,10  ,70 ,100}, {0  ,60 ,100}, 23, 2.2f, {{11,25}, {8,10},{1,15}}},
